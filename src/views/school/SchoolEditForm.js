...
//     useEffect(() => {
//         if (single != null) {
//             setCname(single.category_name);
//             setImage(single.category_image);
//             setPreview(single.category_image); // Set initial preview to the existing image URL
//         }
//     }, [single]);
...
//         setImage(file);
//         setPreview(URL.createObjectURL(file)); // Set new image preview
//     };

//     const update_School = (e) => {
//         e.preventDefault();
//         if (!cname || !image) {
...
//                             <h4 className="card-title mb-4">School Form</h4>
//                                         <form className="forms-sample" method="POST" onSubmit={update_Category}>
//                                             {/* <div className="form-group">
//                                                 <label htmlFor="categorySelect">Category Name</label>
//                                                 <select
//                                                     id="categorySelect" className="form-control" onChange={(e) => setCname(e.target.value)} value={cname}                                                 >
...
//                                                 <input type="text"onChange={(e) => setCname(e.target.value)} value={cname} id="exampleInputName" className="form-control" placeholder="Category name"/>
//                                             </div>
//                                             {/* <div className="form-group">
//                                                 <label htmlFor="exampleInputEmail1">Category Image</label>
//                                                 <input type="file" onChange={(e) => setImage(e.target.files[0])} className="form-control" id="exampleInputCategoryimage"  />
//                                             </div> */}
//                                             <div className="form-group">
//                                                     <label htmlFor="exampleInputEmail1">Category Image</label>
//                                                     <input
//                                                         type="file"
//                                                         onChange={handleImageChange} // New image selection handler
//                                                         className="form-control"
//                                                         id="exampleInputCategoryimage"
//                                                     />
//                                                 </div>

//                                                 {/* Display current image or new image preview */}
//                                                 {preview && (
//                                                     <div className="form-group">
//                                                         <img
//                                                             src={preview}
...
const SchoolEditForm = () => {
    ...
    const insertData = (e) => {
        ...
        // Dispatch updateSchool action
        // dispatch(updateSchool(formData)).then(() => {
        //     navigate("/school"); // Navigate back after successful update
        // });
        dispatch(updateSchool(formData))
        .then(() => {
            navigate("/school");
